...
class Progress {
    ...
    factory Progress.fromJson(Map<String, dynamic> json) => Progress(
        dailyAverages: Map.from(json["dailyAverages"]).map((k, v) => MapEntry<String, DifferenceBetweenTotalAndWithoutLast>(k, DifferenceBetweenTotalAndWithoutLast.fromJson(v))),
        dailyPercentageChanges: Map.from(json["dailyPercentageChanges"]).map((k, v) => MapEntry<String, DifferenceBetweenTotalAndWithoutLast>(k, DifferenceBetweenTotalAndWithoutLast.fromJson(v))),
        weeklyAverages: WeeklyGes.fromJson(json["weeklyAverages"]),
        weeklyPercentageChanges: WeeklyGes.fromJson(json["weeklyPercentageChanges"]),
        totalAverage: DifferenceBetweenTotalAndWithoutLast.fromJson(json["totalAverage"]),
        withoutLastAverage: DifferenceBetweenTotalAndWithoutLast.fromJson(json["withoutLastAverage"]),
        lastInterviewChangePercent: json["lastInterviewChangePercent"]?.toDouble(),
        totalInterviews: json["totalInterviews"],
        dailyOverallAverages: List<LyOverallAverage>.from(json["dailyOverallAverages"].map((x) => LyOverallAverage.fromJson(x))),
        weeklyOverallAverages: List<LyOverallAverage>.from(json["weeklyOverallAverages"].map((x) => LyOverallAverage.fromJson(x))),
        differenceBetweenTotalAndWithoutLast: DifferenceBetweenTotalAndWithoutLast.fromJson(json["differenceBetweenTotalAndWithoutLast"]),
    );

    Map<String, dynamic> toJson() => {
        "dailyAverages": Map.from(dailyAverages).map((k, v) => MapEntry<String, dynamic>(k, v.toJson())),
        "dailyPercentageChanges": Map.from(dailyPercentageChanges).map((k, v) => MapEntry<String, dynamic>(k, v.toJson())),
        ...
        "dailyOverallAverages": List<dynamic>.from(dailyOverallAverages.map((x) => x.toJson())),
        "weeklyOverallAverages": List<dynamic>.from(weeklyOverallAverages.map((x) => x.toJson())),
        "differenceBetweenTotalAndWithoutLast": differenceBetweenTotalAndWithoutLast.toJson(),
    };
}
...
class DifferenceBetweenTotalAndWithoutLast {
    ...
    factory DifferenceBetweenTotalAndWithoutLast.fromJson(Map<String, dynamic> json) => DifferenceBetweenTotalAndWithoutLast(
        articulation: json["Articulation"]?.toDouble(),
        behaviouralCue: json["Behavioural_Cue"]?.toDouble(),
        problemSolving: json["Problem_Solving"],
        inprepScore: json["Inprep_Score"]?.toDouble(),
        contentScore: json["Content_Score"]?.toDouble(),
...
class LyOverallAverage {
    ...
    factory LyOverallAverage.fromJson(Map<String, dynamic> json) => LyOverallAverage(
        date: json["date"],
        average: json["average"]?.toDouble(),
    );
...
class WeeklyGes {
    ...
    factory WeeklyGes.fromJson(Map<String, dynamic> json) => WeeklyGes(
        week1: json["Week 1"] == null ? null : DifferenceBetweenTotalAndWithoutLast.fromJson(json["Week 1"]),
